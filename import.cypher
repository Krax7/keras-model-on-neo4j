...
LOAD CSV WITH HEADERS FROM "http://guides.neo4j.com/listings/data/listings.csv" AS row
...
LOAD CSV WITH HEADERS FROM "http://guides.neo4j.com/listings/data/reviews.csv" AS row
